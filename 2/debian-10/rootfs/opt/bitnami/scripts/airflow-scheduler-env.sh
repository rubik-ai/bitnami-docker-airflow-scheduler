...
AIRFLOW__LINEAGE__BACKEND="${AIRFLOW__LINEAGE__BACKENDAIRFLOW__LINEAGE__BACKEND:-}"
AIRFLOW__LINEAGE__AIRFLOW_SERVICE_NAME="${AIRFLOW__LINEAGE__AIRFLOW_SERVICE_NAME:-}"
AIRFLOW__LINEAGE__OPENMETADATA_API_ENDPOINT="${AIRFLOW__LINEAGE__OPENMETADATA_API_ENDPOINT:-}"
AIRFLOW__LINEAGE__AUTH_PROVIDER_TYPE="${AIRFLOW__LINEAGE__AUTH_PROVIDER_TYPE:-}"
METIS2="${METIS2:-}"
DEPOT_SERVICE_URL="${DEPOT_SERVICE_URL:-}"
HEIMDALL_URL="${HEIMDALL_URL:-}"
DATAOS_RUN_AS_APIKEY="${DATAOS_RUN_AS_APIKEY:-s}"